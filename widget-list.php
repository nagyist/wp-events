...
?>
    <li>
      <a href="<?php echo get_permalink(); ?>"><?php echo get_the_title(); ?> (<?php echo ec3_get_start_time(); ?>)</a>
<?php
          if($show_locations == on) { echo ', Location'; }
          //# Add display locations function.
?>
    </li>
<?php
        }
...
?>
    ...
    <p>
     <label for="<?php echo $this->get_field_id('show_times') ?>">
      <?php printf( 'Show <q>%1$s</q> text', __('All day','ec3')); ?>:
      <input type="checkbox"
